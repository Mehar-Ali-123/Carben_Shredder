...
import Logo from '../../images/logo/footer-logo-2.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#77CFB8] duration-300 ease-linear dark:bg-[#77CFB8] lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ' +
                                (isActive && '!text-white')
                              }
                            >
                              Footprint Tracking
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('transaction-overview') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
